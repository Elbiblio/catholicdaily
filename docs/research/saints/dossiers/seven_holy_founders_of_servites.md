...
- Stable ID: `seven_holy_founders_of_servites`
- Profile kind: group
- Celebration IDs: `seven_holy_founders_of_servites`, `the_seven_holy_founders_of_the_servite_order`
- Canonical name and aliases: The Seven Holy Founders of the Servite Order; Seven Founders of the Order of Servants of Mary
- Feast date and calendar scope: February 17; optional memorial in the General Roman Calendar
- Identity conflicts resolved: The profile treats the founders collectively rather than creating seven parallel biographies. Source forms of individual names vary, and the earliest narrative is an order tradition with uneven historical precision. The dossier retains the well-attested communal foundation, Florence, Monte Senario, development under the Rule of Saint Augustine, institutional approval in 1304, and collective canonization in 1888 while declining disputed longevity, exact parallel life courses, and apparition details as profile facts.
...
|---|---|---|---|---|
| identity, profileKind | The celebration commemorates a founding group whose corporate witness is the proper subject. | vatican-news-founders; servite-monte-senario; treccani-servites | documented | Individuality is not denied, but uneven data are not forced into seven matching biographies. |
| life.florence | Servite tradition remembers seven Florentine laymen associated with commerce and Marian devotion beginning a common life amid civic conflict. | vatican-news-founders; servite-monte-senario | reliably traditional | The traditional year 1233 is retained in the summary but not overloaded with an exact shared apparition date. |
| life.monte_senario | The community established itself at Monte Senario under episcopal guidance, and the place became the order's spiritual home. | vatican-news-founders; servite-monte-senario; treccani-servites | documented with traditional narrative detail | Sources differ on 1234 versus around 1245; the JSON therefore says later withdrawal without assigning an exact year. |
| order | The fraternity developed into the Order of Servants of Mary and adopted the Rule of Saint Augustine. | vatican-news-founders; treccani-servites | documented institutional history | The profile distinguishes communal origin from later canonical maturity. |
...
The profile and prayer are original. No origin legend, liturgical reading, or order text is reproduced. Traditional claims are summarized only to explain why they were not used as documentary biography. No image is included because file-specific creator and license research was not completed.
