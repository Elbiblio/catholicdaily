...
- Identity conflicts resolved: live observance entity `Q2511873`; person entity `Q40662` and artwork entity `Q2727560` rejected. No lifespan, age, vocation, places, or simulated biography. The event is not assigned an exact historical date.
...
| john-passion-calendar | 1 | Liturgy Office, Catholic Bishops' Conference of England and Wales | Liturgical Calendar: Universal Calendar — August | Catholic Bishops' Conference of England and Wales | https://www.liturgyoffice.org.uk/Calendar/Universal/AugUC.shtml | 2026-08-12 | Formal calendar used for the canonical title, August 29 memorial, and red color |

## Claim ledger
| Profile field | Claim or editorial conclusion | Source IDs | Certainty | Reconciliation note |
|---|---|---|---|---|
| identity / observance | August 29 memorial of John's killing, Q2511873 | john-passion-calendar; john-passion-benedict | Documented formal | No person lifespan or biography fields. |
...
| arrays | Patronage and symbols empty | john-passion-calendar | Documented omission | No reviewed formal observance-level token qualified. |
