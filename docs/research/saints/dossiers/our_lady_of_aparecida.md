...
| history.colonial_context | Devotion developed amid crown extraction, poverty, racial hierarchy, and unequal power. | aparecida-domezi; aparecida-race-study | Documented context | Do not make suffering scenery for a consoling national story. |
...
| feastDates | October 12 is a Brazilian solemnity, white. | aparecida-cnbb-calendar | Documented | National, not universal-calendar rank. |
...
- Named colonial extraction, racial hierarchy, Black agency, and contested national reception without extending the reviewed sources beyond their evidence.
