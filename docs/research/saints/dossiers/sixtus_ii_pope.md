...
| sixtus-stuart-jones-catacomb | 2 | H. Stuart Jones | Recent Discoveries in the Catacomb of S. Callistus | The Journal of Theological Studies, vol. 13 (1912) | https://biblicalstudies.org.uk/pdf/jts/013_597.pdf | 2026-08-12 | Historical archaeological review used for the papal crypt, fragments of Damasus's inscription, companion burial evidence, and competing interpretations of Callistus and Praetextatus; its 1912 conclusions are evidence of the excavations and scholarly debate, not a final modern settlement |
| sixtus-ott-critical-reference | 2 | Michael Ott | Pope St. Sixtus II | The Catholic Encyclopedia, vol. 14, Robert Appleton Company, via New Advent | https://www.newadvent.org/cathen/14031c.htm | 2026-08-12 | Recognized 1912 critical reference used specifically to classify the Lawrence farewell as coming from unauthentic Acts, reject crucifixion language as literal history, distinguish later named-roster and chair traditions from Cyprian, and control the false Sentences of Xystus attribution; its older archaeological reconstruction is not treated as current consensus |
| sixtus-calendar | 1 | Liturgy Office, Catholic Bishops' Conference of England and Wales | Liturgical Calendar: Universal Calendar — August | Catholic Bishops' Conference of England and Wales | https://www.liturgyoffice.org.uk/Calendar/Universal/AugUC.shtml | 2026-08-12 | Formal calendar used for the collective title St Sixtus II, Pope, Martyr, and Companions, Martyrs, August 7 optional memorial, and red color; the key establishes that an entry without a printed rank is optional |
...
| archaeology.damasus | Papal-crypt excavation and fragments of Damasus's inscription support early cult while burial and execution-location interpretations remained disputed. | sixtus-stuart-jones-catacomb | Mixed archaeological interpretation | Use as an age-qualified excavation review, not final modern consensus. |
| later Passion | The Lawrence farewell comes from unauthentic Acts; chair, named-roster, crucifixion, and detailed execution traditions exceed Cyprian and the early calendar. | sixtus-ott-critical-reference; sixtus-cyprian-81; sixtus-depositio-354 | Low — later tradition omitted from historical core | The 1912 reference is used for source criticism, not its entire reconstruction. No graphic details or fabricated last words. |
